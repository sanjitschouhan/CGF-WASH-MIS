...
import in.collectivegood.dbsibycgf.heps.HEPSDataFormActivity;
...
public class CheckInActivity extends AppCompatActivity {
    ...
    private void initialiseReferences() {
        ...
        searchQueryInputEditText = (EditText) findViewById(R.id.cc_search_query_input);
        schoolListView = (ListView) findViewById(R.id.checkin_school_list);
    ...
    private void addListeners() {
        ...
        schoolListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(CheckInActivity.this, CheckInLoadingActivity.class);
