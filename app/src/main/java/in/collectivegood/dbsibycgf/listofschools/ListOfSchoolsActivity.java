package in.collectivegood.dbsibycgf.listofschools;
...
import in.collectivegood.dbsibycgf.checkin.CheckInLoadingActivity;
...
import in.collectivegood.dbsibycgf.profiles.SchoolProfileActivity;
import in.collectivegood.dbsibycgf.support.InfoProvider;

public class ListOfSchoolsActivity extends AppCompatActivity {
    ...
    private void initialiseReferences() {
        ...
        searchQueryInputEditText = (EditText) findViewById(R.id.school_search_query_input);
        schoolListView = (ListView) findViewById(R.id.ssschool_list);
    ...
    private void addListeners() {
        ...
        schoolListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ListOfSchoolsActivity.this, SchoolProfileActivity.class);
