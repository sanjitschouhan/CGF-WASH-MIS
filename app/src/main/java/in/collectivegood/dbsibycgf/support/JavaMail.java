...
public class JavaMail {
    ...
    public static void mail(Context context1, String userMail) {
        context = context1;
        filename = Environment.getExternalStorageDirectory() + "/" + context.getString(R.string.app_name) + "/heps_data.csv";
        createFileAndSendMail(userMail);
    }

    private static void createFileAndSendMail(final String userMail) {
    ...
    private static void sendMail(String to, String subject) {
